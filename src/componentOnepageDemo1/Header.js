...
class Header extends Component {
    render() {
        return (    /**<!-- Header-->trước khi paste vào đây thì copy code html, paste vào https://magic.reactjs.net/htmltojsx.htm*/
            <header className="masthead text-center text-white"> {/**để chuyển đổi thành jsx */}
